...
public class BalanceLog {
    public double balancePoint(Log log) {
        // YOUR CODE HERE
        double X = log.length()/2.0;
        double leftWeight = log.weightUpto(X);
        double rightWeight = log.weightUpto(log.length())- leftWeight;
        while(leftWeight!=rightWeight){
            ...
            leftWeight = log.weightUpto(X);
            rightWeight = log.weightUpto(log.length())- leftWeight;
        }
